<template>
    <main class="container mx-auto">
        ...
        <AuthBox
            description="Escribe tu correo electrónico a continuación y te enviaremos un email con las instrucciones sobre cómo crear una nueva contraseña."
...
export default {
    ...
    head() {
        return {
            title: 'Recuperación de contraseña | AilynMS'
        }
    },
        ...
        async recovery() {
            ...
            if (this.formCompleted) {
                try {
                    ...
                    const response = await this.$axios.$post('/password/link', data);
                    return this.$router.push('/auth/recovery_password/verify');
